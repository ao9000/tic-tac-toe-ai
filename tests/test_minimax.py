...
def test_board_human_1st_turn():
    for turn_num in range(1, 9):
        ...
        for board in boards:
            minimax_result = minimax(board, get_depth(board), False if turn_num % 2 == 0 else True)
            minimax_soft_alpha_beta_result = minimax_soft_alpha_beta(board, get_depth(board), False if turn_num % 2 == 0 else True, -inf, +inf)
            minimax_alpha_beta_result = minimax_alpha_beta(board, get_depth(board), False if turn_num % 2 == 0 else True, -inf, +inf)
...
def test_board_bot_1st_turn():
    for turn_num in range(1, 9):
        ...
        for board in boards:
            minimax_result = minimax(board, get_depth(board), True if turn_num % 2 == 0 else False)
            minimax_soft_alpha_beta_result = minimax_soft_alpha_beta(board, get_depth(board), True if turn_num % 2 == 0 else False, -inf, +inf)
            minimax_alpha_beta_result = minimax_alpha_beta(board, get_depth(board), True if turn_num % 2 == 0 else False, -inf, +inf)
